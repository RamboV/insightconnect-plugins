...
|Name|Type|Default|Required|Description|Enum|Example|
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|agent|[]string|None|True|Agent to perform quarantine action on. Accepts IP address, MAC address, hostname, UUID or agent ID|None|["hostname123", "hostname456"]|
...
* 9.0.0 - Updated the output schema for `Quarantine` action
